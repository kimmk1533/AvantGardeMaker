...
namespace AvantGardeMaker.ad1a
{
	public class EnemyFixedData
	{
		...
		public E_EnemyRaceType m_TribeType;
	...
	public class EnemyVariableData
	{
		...
		public CombatStatValue<float> m_ElementRes;//원소 내성
	...
	{
		public EnemyFixedData m_FixedData;
		public EnemyVariableData m_VariableData;
		...
		//	E_EnemyRaceType type = E_EnemyRaceType.E_Ect, E_EnemyFlyable flyable = E_EnemyFlyable.E_Walk,
